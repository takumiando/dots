...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#111111', '#333333', '#555555', '#ff8c00', '#888888', '#bbbbbb', '#dddddd', '#ffffff', '#111111', '#333333', '#555555', '#ff8c00', '#888888', '#bbbbbb', '#dddddd', '#ffffff']"
...
gset string palette "#111111:#333333:#555555:#ff8c00:#888888:#bbbbbb:#dddddd:#ffffff:#111111:#333333:#555555:#ff8c00:#888888:#bbbbbb:#dddddd:#ffffff"
